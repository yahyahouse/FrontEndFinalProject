    ...
    return (
        <div className="">
            ...
            <div className="sm:flex sm:px-[236px] gap-[32px] sm:mt-10 relative">
                {/* <div className="absolute top-[44px] left-[16px] z-50 bg-white rounded-full sm:hidden" to="/" >
                ...
                <div className=" w-full px-4 sm:px-0 absolute sm:static top-[380px] z-20">
                    <div className="container flex w-full -mt-10 z-50 sm:mt-0 static bg-white rounded-2xl">
                        <div className="border rounded-xl shadow-lg p-5 w-full sm:w-auto">
                            ...
                            <button className=" duration-[1s] w-[300px] h-[40px] rounded-2xl bg-purple-700 items-center text-white hidden sm:block ">Terbitkan</button>
                            <button className="w-[300px] h-[40px] mt-4 border-2 rounded-2xl border-purple-700 justify-center items-center font-medium hidden sm:block">Edit</button>
                        </div>
                    </div>
            ...
            <button className=" duration-[1s] w-[350px] h-[40px] rounded-2xl 
