...
const Modal08 = ({ showModal, setShowModal }) => {
  const closeModal = () => {
  ...
  return (
    <>
      {showModal ? (
        <div className="sm:items-center sm:justify-center bg-black absolute bg-opacity-50 inset-0 flex items-end overflow-hidden">
          {/* <div ref={ref} id="klik" /> */}
          <div
            id="modal"
            className="first:animate-modalout last:animate-modalin sm:rounded-2xl sm:w-[360px] duration-[1s] bg-white w-full flex flex-col items-center rounded-t-[16px]"
          >
            <button
              id="klik"
              onClick={closeModal}
